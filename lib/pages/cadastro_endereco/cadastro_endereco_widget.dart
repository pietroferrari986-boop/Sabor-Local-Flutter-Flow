      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed(PagDeLoginWidget.routeName);
                        },
                        child: Text(
                          'Entrar',
                          style:
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(110.0, 50.0, 110.0, 0.0),
              child: Container(
                width: double.infinity,
                height: 130.0,
                decoration: BoxDecoration(),
                        ...
                        children: [
                          ...
                          if (Theme.of(context).brightness == Brightness.dark)
                            ClipRRect(
                              borderRadius: BorderRadius.circular(0.0),
                              child: Image.asset(
                                'assets/images/Logo_Circled_Final.png',
                                width: 120.0,
                                height: 120.0,
                                fit: BoxFit.cover,
                              ),
